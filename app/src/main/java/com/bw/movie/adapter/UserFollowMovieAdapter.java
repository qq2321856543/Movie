...
public class UserFollowMovieAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    private List<UserFollowMovieBean.ResultBean> list=new ArrayList<>();

    public UserFollowMovieAdapter(Context context) {
        this.context = context;
    }
    public void setData(List<UserFollowMovieBean.ResultBean> mlist){
        list = mlist;
