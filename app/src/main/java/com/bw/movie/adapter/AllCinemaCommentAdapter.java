...
public class AllCinemaCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    List<AllCinemaCommentBean.ResultBean> result;


    public AllCinemaCommentAdapter(Context context, List<AllCinemaCommentBean.ResultBean> result) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = View.inflate(context, R.layout.item_yingyuanping, null);
