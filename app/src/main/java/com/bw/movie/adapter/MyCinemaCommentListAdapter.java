...
public class MyCinemaCommentListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    //TODO:用户对影院的评论列表
    Context context;
    private List<MyMovieCommentListBean.ResultBean> list=new ArrayList<>();

    public MyCinemaCommentListAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = View.inflate(context, R.layout.item_mycinemacommentlist, null);
